...
SQLALCHEMY_DATABASE_URI = os.environ.get('{{cookiecutter.app_name}}_DB_URI', 'sqlite:///../{{cookiecutter.app_name}}/{{cookiecutter.app_name}}.db')

alembic_path = os.path.abspath(os.path.dirname(os.path.abspath(__file__)))
{{cookiecutter.app_name}}_path = os.path.join(alembic_path, os.pardir)

sys.path.append({{cookiecutter.app_name}}_path)
